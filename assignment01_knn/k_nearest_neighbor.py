...
class KNearestNeighbor:
    ...
    def compute_distances_no_loops(self, X):
        ...
        dists = np.sqrt(test_sum + train_sum + cross_term)
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            #########################################################################
            # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            # Find indices of k nearest neighbors for the i-th test point
            nearest_neighbor_indices = np.argsort(dists[i])[:k]
            
            # Extract the labels of the k nearest neighbors from self.y_train
